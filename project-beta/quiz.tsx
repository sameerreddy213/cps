      ...
      {!submitted && isFullScreen && (
        <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', marginBottom: '20px' }}>
          <div style={{ display: 'flex', gap: '20px' }}>
            ...
            <span style={{ fontWeight: 'bold', color: 'red' }}>Unanswered: {unattemptedQuestions}</span>
            ...
            <div style={{ marginTop: '20px' }}>
              ...
              >
                ...
                >
                  ...
                  <p style={{ fontSize: '24px', fontWeight: 'bold', color: currentTheme.buttonPrimary }}>{unattemptedQuestions}</p>
                </div>
                <div
                  style={{
                    padding: '20px',
